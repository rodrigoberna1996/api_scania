...
from app.services.sharepoint_auth.storage import save_items_to_db
...
async def update_sharepoint_items():
    ...
    url = ("https://graph.microsoft.com/v1.0/sites/truiz.sharepoint.com,a0d38210-52a9-4619-a001-fdde7017c0cc,"
           "7cbea3f9-6e3a-44fc-8af8-ac97fc715b40/lists/bdb21716-0291-4959-afb7-f801ac9983c5/items?$expand=fields")
